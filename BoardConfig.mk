...
TARGET_KERNEL_HEADERS := kernel/xiaomi/cezanne
TARGET_KERNEL_CONFIG := vendor/cezanne_user_defconfig
TARGET_FORCE_PREBUILT_KERNEL := true
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/bootimg/kernel.img
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/bootimg/dtb.img
...
# Sepolicy
BOARD_SEPOLICY_DIR += $(DEVICE_PATH)/sepolicy-minimal
